        ...
        <div className="flex items-center justify-between h-[110px]">
          ...
          <Link to="/" className="flex items-center gap-4 shrink-0 overflow-visible">
            ...
            <div className="hidden sm:block text-center">
              <h1 className="font-serif font-extrabold text-4xl text-primary-foreground leading-tight tracking-tight">
                NETHAJI VIDHYALAYAM
              </h1>
              <p className="font-sans font-bold text-accent text-[15px] tracking-widest">CHENNAI - KOVILAMBAKKAM</p>
            </div>
          </Link>
